// icons.jsx — small, hand-crafted stroke icons. 14×14 default.
// All stroke="currentColor", strokeWidth 1.5, never filled (except node dots).
...
const Ic = {
  ...
  // tiny helpers for inline annotation
  Spinner: (p) => (
